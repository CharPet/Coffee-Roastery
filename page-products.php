...
<main>
    ...
    <section class="products-grid">
        <div class="product-card" data-name="Espresso Crema" data-price="10.00">
            ...
            <button class="buy-btn">Αγορά</button>
        </div>
        <div class="product-card" data-name="Single Origin – Αιθιοπία" data-price="12.00">
            <img src="<?php echo get_template_directory_uri(); ?>/images/az2voykpums9xyjsxide.webp" alt="Product 2" />
        ...
        <div class="product-card" data-name="Blend Terra – Υπογραφή Καβουρδίσματος" data-price="9.00">
            <img src="<?php echo get_template_directory_uri(); ?>/images/w4xpa1kuk8tzugcxrzdm.webp" alt="Product 3" />
        ...
        <div class="product-card" data-name="Decaf Φυσικής Επεξεργασίας" data-price="10.00">
            <img src="<?php echo get_template_directory_uri(); ?>/images/rfgmlfieuoikezhdn4le.webp" alt="Product 4" />
        ...
        <div class="product-card" data-name="Cold Brew Blend" data-price="11.00">
            <img src="<?php echo get_template_directory_uri(); ?>./images/rpofgcnxms63tpyj5pcv.webp" alt="Product 5" />
        ...
        <div class="product-card" data-name="Filter Roast – Γουατεμάλα" data-price="14.00">
            <img src="<?php echo get_template_directory_uri(); ?>/images/toa-heftiba-WsDF95mSUsI-unsplash.webp"
                alt="Product 6" />
        ...
        <div class="product-card" data-name="Καφές Κατσαρόλας Παραδοσιακός" data-price="10.00">
            <img src="<?php echo get_template_directory_uri(); ?>/images/ritzgcf4vyfzt8tsimaz.webp" alt="Product 7" />
        ...
        <div class="product-card" data-name="Limited Harvest – Μικρές Παραγωγές" data-price="16.00">
            <img src="<?php echo get_template_directory_uri(); ?>/images/i6qzh2ainazes9kpnptx.webp" alt="Product 28" />
